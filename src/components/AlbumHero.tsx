      ...
      <div className="relative min-h-[34rem] overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 p-5 sm:p-8 lg:p-10">
          <div className="max-w-4xl text-white">
            ...
            <p className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.18em] text-[#f4d9a8]">
            ...
            <p className="mt-4 flex max-w-3xl items-start gap-2 text-base leading-7 text-white/88 sm:text-lg">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center">
              {hasUrl ? (
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-white/85 px-6 py-3 font-semibold text-black shadow-lg shadow-black/15 backdrop-blur-xl transition hover:-translate-y-0.5 hover:bg-white"
                >
                ...
                <span className="inline-flex cursor-not-allowed items-center justify-center gap-2 rounded-full bg-app-card/35 px-6 py-3 font-semibold text-white backdrop-blur-md">
                  <Camera className="h-5 w-5" />
                  Open full photo album
                  <ExternalLink className="h-5 w-5" />
                </span>
