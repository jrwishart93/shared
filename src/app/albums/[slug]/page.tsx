...
import { AdminEditableDescription } from "@/components/AdminEditableDescription";
    ...
    <ProtectedRoute>
      <main className="min-h-[calc(100vh-73px)] bg-app-bg px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
        <div className="mx-auto max-w-5xl space-y-6">
          <MotionSection className="liquid-panel overflow-hidden rounded-3xl">
